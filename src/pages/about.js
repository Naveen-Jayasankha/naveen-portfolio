...
const about = () => {
  return (
    <>
        <Head>
            <title>naveenjayasankha | About Page </title>
       ...
       <main className='flex w-full flex-col items-center justify-center'>
            ...
            Hi, I'm Naveen, a web developer and UI/UX designer with a passion for creating beautiful, functional, 
...
'>
    ...
    <Image src={profilePic} alt="NaveenJ" className='w-full h-auto rounded-2xl'/>
</div>
